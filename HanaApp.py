...
if submitted:
    input_dict = {
        ...
        'Notes': safe_transform(notes, label_encoders['Notes']),
        'Listening_in_Class': safe_transform(listening_in_class, label_encoders['Listening_in_Class']),
        'Project_work': safe_transform(project_work, label_encoders['Project_work'])
    }
...
if submitted:
    ...
    st.success(f"🎯 Predicted Score: {prediction:.2f} ➝ {letter_grade}")
